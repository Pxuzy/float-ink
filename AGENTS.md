...
- Login, cloud sync, analytics, networking
...
- Do not use AccessibilityService, MediaProjection, PixelCopy, camera, microphone, storage, or network permissions.
...
5. Keep commits small, using Chinese conventional messages such as `feat: 添加悬浮按钮原型`.
